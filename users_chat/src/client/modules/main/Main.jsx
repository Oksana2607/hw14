        ...
        <div className='wrapper'>
            ...
            <div className='wrapper__user user'>
                ...
                <div className='user__logout'>
                    <button className='user__logout logout' id='logoutBtn' onClick={() => handleModule('login')}>Log
                        out
                    </button>
                </div>
            </div>
                ...
                <div className='users__buttons'>
                    <div className='users__button button-users'>
                        <button className='button-users__btn' id='usersBtn'
                                onClick={() => handleClick('usersTable')}>Users
                        </button>
                    </div>
                    <div className='users__button button-chat'>
                        <button className='button-chat__btn' id='chatBtn' onClick={() => handleClick('chat')}>Chat
                        </button>
                    </div>
