        ...
        <div className='wrapper'>
            ...
            <div className='wrapper__user user'>
                ...
                <div className='user__logout'>
                    <button className='user__logout toggleTheme' onClick={toggleTheme}>
                        <p id='toggleBtn'>
                            <i className='fas fa-moon'></i>
                            <i className='fas fa-sun'></i>
                        </p>
                    </button>
                    <button className='user__logout logout' id='logoutBtn' onClick={handleModule}>{t('logOut')}</button>
                </div>
            </div>
            <div className='wrapper__users users'>
                <div className='users__buttons'>
                    <div className='users__button button-users'>
                        <button className='button-users__btn' id='usersBtn' onClick={() => handleClick('usersTable')}>{t('users')}</button>
                    </div>
                    <div className='users__button button-chat'>
                        <button className='button-chat__btn' id='chatBtn' onClick={() => handleClick('chat')}>{t('chat')}</button>
                    </div>
